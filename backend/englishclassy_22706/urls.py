"""englishclassy_22706 URL Configuration
...
admin.site.site_header = "EnglishClassy"
admin.site.site_title = "EnglishClassy Admin Portal"
admin.site.index_title = "EnglishClassy Admin"

# swagger
api_info = openapi.Info(
    title="EnglishClassy API",
    default_version="v1",
    description="API documentation for EnglishClassy App",
)
